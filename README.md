...
Taken from [tensorflow GPU support setup page](https://www.tensorflow.org/install/gpu) with some minor tweak. Note that, it is important to ensure that your instance is indeed compatible with the libraries.
